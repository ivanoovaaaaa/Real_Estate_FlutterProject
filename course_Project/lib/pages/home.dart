...
class _DestinationCarouselState extends State<DestinationCarousel> {
  ...
  String currentSortCriteria = 'default';

  List<Property> sortPropertiesByPrice(List<Property> properties, bool ascending) {
    properties.sort((a, b) {
  ...
  List<Property> sortPropertiesByArea(List<Property> properties, bool ascending) {
    properties.sort((a, b) {
            ...
            GestureDetector(
              onTap: () async {
                ...
                await FilterDialog.show(context, (areaValues, costValues, yearBuiltValues, selectedRentTypes, selectedRooms, selectedCondition, isSuitableForChildren, isPetsAllowed) async {
                  ...
                  sortProperty = filterProperties(selectedRentTypes, selectedRooms, selectedCondition, areaValues, costValues, yearBuiltValues);
            ...
            children: [
              IconButton(
                onPressed: () {
                  ...
                  sortProperty = sortPropertiesByPrice(properties,true);
                },
                icon: Row(
                  children: [
              ...
              IconButton(
                onPressed: () {
                  setState(() {
                    currentSortCriteria = 'price_desc';
                  });
                  sortProperty = sortPropertiesByPrice(properties,false);
                },
                icon: Row(
                  children: [
              ...
              IconButton(
                onPressed: () {
                  setState(() {
                    currentSortCriteria = 'area_asc';
                  });
                  sortProperty = sortPropertiesByArea(properties,true);
                },
                icon: Row(
                  children: [
                    Icon(Icons.arrow_upward),
              ...
              IconButton(
                onPressed: () {
                  setState(() {
                    currentSortCriteria = 'area_desc';
                  });
                  sortProperty = sortPropertiesByArea(properties,false);
                },
                icon: Row(
                  children: [
            ...
            children: [
              ...
              Padding(
                ...
                child: FutureBuilder<List<Property>>(
                  future: DatabaseHelper().getAllProperties(),
                  builder: (context, snapshot) {
                    if (snapshot.connectionState == ConnectionState.waiting) {
                      ...
                      if (currentSortCriteria != 'default') {
                       displayProperties = sortProperty;
                      }
